---
title: "acesinabcd_acesproxy_6p0adapation"
author: "BL"
date: "2025-09-24"
output:
...
ela_in_abcd_data=readRDS("ela_in_abcd.rds")
mh_py_le_bs=read.csv("mh_py_le_bs.csv")

#filter rows with NDAR- instead of sub- prefixes, these are duplicates from the setup code 
#and due to differences in the 5.1 and 6.0 subject ID naming conventions 

ela_in_abcd <- ela_in_abcd_data %>%
  filter(!grepl("^NDAR_", src_subject_id))
...
#create dataframe with physical abuse items
#KSADS data is cut off at year 2
abuse_phy_yr4_data = c("ksads_ptsd_raw_761_p"  , "ksads_ptsd_raw_762_p", "ksads_ptsd_raw_763_p", "ksads_ptsd_raw_764_p", "ksads_ptsd_raw_765_p")

#sum the items as long as they're not all NA
#pulling year 2 data to sub in for year 4 
ela_in_abcd_yr4$abuse_phy_sum = apply(ela_in_abcd_yr2[abuse_phy_yr2_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr4$abuse_phy_yr4 = ifelse(ela_in_abcd_yr4$abuse_phy_sum == 0, 0, 1)
...
#create dataframe with sexual abuse items
abuse_sex_yr4_data = c("ksads_ptsd_raw_767_p"  , "ksads_ptsd_raw_768_p", "ksads_ptsd_raw_769_p")

#sum the items as long as they're not all NA
ela_in_abcd_yr4$abuse_sex_sum = apply(ela_in_abcd_yr2[abuse_sex_yr2_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr4$abuse_sex_yr4 = ifelse(ela_in_abcd_yr4$abuse_sex_sum == 0, 0, 1)
...
#no recode necessary (binary yes/no variable)
ela_in_abcd_yr4$abuse_emo_yr4 = ela_in_abcd_yr4$fes_youth_q5 
...
#create dataframe with physical neglect items
neglect_phy_yr4_data = c("demo_fam_exp1_v2_l"  , "demo_fam_exp6_v2_l", "demo_fam_exp7_v2_l")

#sum the items as long as they're not all NA
ela_in_abcd_yr4$neglect_phy_sum = apply(ela_in_abcd_yr4[neglect_phy_yr4_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr4$neglect_phy_yr4 = ifelse(ela_in_abcd_yr4$neglect_phy_sum == 0, 0, 1)


#neglect_emo
#CRPBI parent *CRPBI Mean Parent (primary caregiver)Y crpbi_y_ss_parent_ace

ela_in_abcd_yr4$neglect_emo_yr4 = ela_in_abcd_yr4$crpbi_y_ss_parent_ace
...
#create dataframe with divorce items
divorce_yr4_data = c("ple_separ_p"  , "ple_separ_y")

#sum the items as long as they're not all NA
ela_in_abcd_yr4$divorce_sum = apply(ela_in_abcd_yr4[divorce_yr4_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr4$divorce_yr4 = ifelse(ela_in_abcd_yr4$divorce_sum == 0, 0, 1)
...
#no recode necessary (binary yes/no variable)
#reuse from year 2 KSADS
ela_in_abcd_yr4$violence_yr4 = ela_in_abcd_yr2$ksads_ptsd_raw_766_p
...
#create dataframe with mental illness items
mi_yr4_data = c("ple_mh_p", "ple_mh_y", "asr_scr_totprob_t_ace")

#sum the items as long as they're not all NA
ela_in_abcd_yr4$mi_sum = apply(ela_in_abcd_yr4[mi_yr4_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr4$mi_yr4 = ifelse(ela_in_abcd_yr4$mi_sum == 0, 0, 1)
...
#create dataframe with incarceration items
incar_yr4_data = c("ple_arrest_p"  , "ple_arrest_y" , "ple_law_p", "ple_law_y", "ple_jail_p", "ple_jail_y")

#sum the items as long as they're not all NA
ela_in_abcd_yr4$incar_sum = apply(ela_in_abcd_yr4[incar_yr4_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr4$incar_yr4 = ifelse(ela_in_abcd_yr4$incar_sum == 0, 0, 1)
...
#create dataframe with substance use items
su_yr4_data = c("ple_sud_p","ple_sud_y","asr_q06_p_ace")

#sum the items as long as they're not all NA
ela_in_abcd_yr4$su_sum = apply(ela_in_abcd_yr4[su_yr4_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr4$su_yr4 = ifelse(ela_in_abcd_yr4$su_sum == 0, 0, 1)
...
ela_in_abcd_yr5$abuse_emo_yr5 = ela_in_abcd_yr5$fes_youth_q5 
...
#create dataframe with phys neglect items
neglect_phy_yr5_data = c("demo_fam_exp1_v2_l" , "demo_fam_exp6_v2_l", "demo_fam_exp7_v2_l")

#sum the items as long as they're not all NA
ela_in_abcd_yr5$neglect_phy_sum = apply(ela_in_abcd_yr5[neglect_phy_yr5_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr5$neglect_phy_yr5 = ifelse(ela_in_abcd_yr5$neglect_phy_sum == 0, 0, 1)


#neglect_emo
#CRPBI parent *CRPBI Mean Parent (primary caregiver)Y crpbi_y_ss_parent_ace

ela_in_abcd_yr5$neglect_emo_yr5 = ela_in_abcd_yr5$crpbi_y_ss_parent_ace
...
#create dataframe with divorce items
divorce_yr5_data = c("ple_separ_p" , "ple_separ_y")

#sum the items as long as they're not all NA
ela_in_abcd_yr5$divorce_sum = apply(ela_in_abcd_yr5[divorce_yr5_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr5$divorce_yr5 = ifelse(ela_in_abcd_yr5$divorce_sum == 0, 0, 1)
...
#create dataframe with mental illness items
mi_yr5_data = c("ple_mh_p" , "ple_mh_y")

#sum the items as long as they're not all NA
ela_in_abcd_yr5$mi_sum = apply(ela_in_abcd_yr5[mi_yr5_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr5$mi_yr5 = ifelse(ela_in_abcd_yr5$mi_sum == 0, 0, 1)
...
#create dataframe with incarceration items
incar_yr5_data = c("ple_arrest_p" , "ple_arrest_y", "ple_law_p", "ple_law_y", "ple_jail_p", "ple_jail_y")

#sum the items as long as they're not all NA
ela_in_abcd_yr5$incar_sum = apply(ela_in_abcd_yr5[incar_yr5_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr5$incar_yr5 = ifelse(ela_in_abcd_yr5$incar_sum == 0, 0, 1)


#Substance Use
#Life Events Family member had drug and/or alcohol problem?Y,P ple_sud_p/ple_sud_y (ple_sud_p_yr5/ple_sud_y_yr5)
#No ASR or Fam Hx at Y5

#create dataframe with substance abuse items
su_yr5_data = c("ple_sud_p" , "ple_sud_y")

#sum the items as long as they're not all NA
ela_in_abcd_yr5$su_sum = apply(ela_in_abcd_yr5[su_yr5_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr5$su_yr5 = ifelse(ela_in_abcd_yr5$su_sum == 0, 0, 1)
...
#create dataframe with physical abuse items
#KSADS data is cut off at year 2 
abuse_phy_yr6_data = c("ksads_ptsd_raw_761_p"  , "ksads_ptsd_raw_762_p", "ksads_ptsd_raw_763_p", "ksads_ptsd_raw_764_p", "ksads_ptsd_raw_765_p")

#sum the items as long as they're not all NA
#filling in with year 2 (ses-02A) from 5.1 
ela_in_abcd_yr6$abuse_phy_sum = apply(ela_in_abcd_yr2[abuse_phy_yr2_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr6$abuse_phy_yr6 = ifelse(ela_in_abcd_yr6$abuse_phy_sum == 0, 0, 1)
...
#create dataframe with sexual abuse items
abuse_sex_yr6_data = c("ksads_ptsd_raw_767_p"  , "ksads_ptsd_raw_768_p", "ksads_ptsd_raw_769_p")

#sum the items as long as they're not all NA
ela_in_abcd_yr6$abuse_sex_sum = apply(ela_in_abcd_yr2[abuse_sex_yr2_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr6$abuse_sex_yr6 = ifelse(ela_in_abcd_yr6$abuse_sex_sum == 0, 0, 1)
...
#no recode necessary (binary yes/no variable)
ela_in_abcd_yr6$abuse_emo_yr6 = ela_in_abcd_yr6$fes_youth_q5 
...
#create dataframe with physical neglect items
neglect_phy_yr6_data = c("demo_fam_exp1_v2_l"  , "demo_fam_exp6_v2_l", "demo_fam_exp7_v2_l")

#sum the items as long as they're not all NA
ela_in_abcd_yr6$neglect_phy_sum = apply(ela_in_abcd_yr6[neglect_phy_yr6_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr6$neglect_phy_yr6 = ifelse(ela_in_abcd_yr6$neglect_phy_sum == 0, 0, 1)


#neglect_emo
#CRPBI parent *CRPBI Mean Parent (primary caregiver)Y crpbi_y_ss_parent_ace

ela_in_abcd_yr6$neglect_emo_yr6 = ela_in_abcd_yr6$crpbi_y_ss_parent_ace

#divorce
#Life Events Parents separated or divorced?Y,P ple_separ_p/ple_separ_y (ple_separ_p_yr2/ple_separ_y_yr2)

#create dataframe with divorce items
divorce_yr6_data = c("ple_separ_p"  , "ple_separ_y")

#sum the items as long as they're not all NA
ela_in_abcd_yr6$divorce_sum = apply(ela_in_abcd_yr6[divorce_yr6_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr6$divorce_yr6 = ifelse(ela_in_abcd_yr6$divorce_sum == 0, 0, 1)
...
#no recode necessary (binary yes/no variable)
ela_in_abcd_yr6$violence_yr6 = ela_in_abcd_yr2$ksads_ptsd_raw_766_p
...
#create dataframe with mental illness items
mi_yr6_data = c("ple_mh_p", "ple_mh_y", "asr_scr_totprob_t_ace")

#sum the items as long as they're not all NA
ela_in_abcd_yr6$mi_sum = apply(ela_in_abcd_yr6[mi_yr6_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr6$mi_yr6 = ifelse(ela_in_abcd_yr6$mi_sum == 0, 0, 1)
...
#create dataframe with incarceration items
incar_yr6_data = c("ple_arrest_p"  , "ple_arrest_y" , "ple_law_p", "ple_law_y", "ple_jail_p", "ple_jail_y")

#sum the items as long as they're not all NA
ela_in_abcd_yr6$incar_sum = apply(ela_in_abcd_yr6[incar_yr6_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr6$incar_yr6 = ifelse(ela_in_abcd_yr6$incar_sum == 0, 0, 1)


#Substance Use
#Life Events Family member had drug and/or alcohol problem?Y,P ple_sud_p/ple_sud_y (ple_sud_p_yr6/ple_sud_y_yr6)
#Adult Self-Report I use drugs (other than alcohol, nicotine) for nonmedical purposesP asr_q06_p_ace
#No Fam Hx update at Y2

#create dataframe with substance use items
su_yr6_data = c("ple_sud_p","ple_sud_y","asr_q06_p_ace")

#sum the items as long as they're not all NA
ela_in_abcd_yr6$su_sum = apply(ela_in_abcd_yr6[su_yr6_data],1, sum_score)

#binary recode as anything > 0 is 1
ela_in_abcd_yr6$su_yr6 = ifelse(ela_in_abcd_yr6$su_sum == 0, 0, 1)
...
yr4_scores_tmp = ela_in_abcd_yr4[c("src_subject_id", "abuse_phy_yr4", "abuse_sex_yr4", "abuse_emo_yr4", "neglect_phy_yr4", "neglect_emo_yr4", "divorce_yr4", "violence_yr4", "mi_yr4", "incar_yr4", "su_yr4")]    
yr5_scores_tmp = ela_in_abcd_yr5[c("src_subject_id", "abuse_emo_yr5", "neglect_phy_yr5", "neglect_emo_yr5", "divorce_yr5", "mi_yr5", "incar_yr5", "su_yr5")]
yr6_scores_tmp = ela_in_abcd_yr6[c("src_subject_id", "abuse_phy_yr6", "abuse_sex_yr6", "abuse_emo_yr6", "neglect_phy_yr6", "neglect_emo_yr6",  "divorce_yr6", "violence_yr6", "mi_yr6", "incar_yr6", "su_yr6")]     

yr1 = left_join(bs_scores,yr1_scores_tmp, by=c("src_subject_id")) 
yr2 = left_join(yr1, yr2_scores_tmp, by=c("src_subject_id")) 
yr3 = left_join(yr2, yr3_scores_tmp, by=c("src_subject_id")) 
yr4 = left_join(yr3, yr4_scores_tmp, by=c("src_subject_id")) 
yr5 = left_join(yr4, yr5_scores_tmp, by=c("src_subject_id")) 
ela_final = left_join(yr5, yr6_scores_tmp, by=c("src_subject_id"))
...
#yr4 by domain
ela_final$abuse_phy_yr4_build = ifelse(ela_final$abuse_phy_bs == 0 & ela_final$abuse_phy_yr4 == 0, 0, 1)
ela_final$abuse_sex_yr4_build = ifelse(ela_final$abuse_sex_bs == 0 & ela_final$abuse_sex_yr4 == 0, 0, 1)
ela_final$abuse_emo_yr4_build = ifelse(ela_final$abuse_emo_bs == 0 & ela_final$abuse_emo_yr3 == 0 & ela_final$abuse_emo_yr4 == 0, 0, 1)
ela_final$neglect_phy_yr4_build = ifelse(ela_final$neglect_phy_bs == 0 & ela_final$neglect_phy_yr3 == 0 & ela_final$neglect_phy_yr4 == 0, 0, 1)
ela_final$neglect_emo_yr4_build = ifelse(ela_final$neglect_emo_bs == 0 & ela_final$neglect_emo_yr3 == 0 & ela_final$neglect_emo_yr4 == 0, 0, 1)
ela_final$divorce_yr4_build = ifelse(ela_final$divorce_bs == 0 & ela_final$divorce_yr3 == 0 & ela_final$divorce_yr4 == 0, 0, 1)
ela_final$violence_yr4_build = ifelse(ela_final$violence_bs == 0 & ela_final$violence_yr4 == 0, 0, 1)
ela_final$mi_yr4_build = ifelse(ela_final$mi_bs == 0 & ela_final$mi_yr3 == 0 & ela_final$mi_yr4 == 0, 0, 1)
ela_final$incar_yr4_build = ifelse(ela_final$incar_bs == 0 & ela_final$incar_yr3 == 0 & ela_final$incar_yr4 == 0, 0, 1)
ela_final$su_yr4_build = ifelse(ela_final$su_bs == 0 & ela_final$su_yr3 == 0 & ela_final$su_yr4 == 0, 0, 1)

#yr4 sum score
ela_final$aces_yr4_build = ela_final$abuse_phy_yr4_build + ela_final$abuse_sex_yr4_build + ela_final$abuse_emo_yr4_build + ela_final$neglect_phy_yr4_build + ela_final$neglect_emo_yr4_build + ela_final$divorce_yr4_build + ela_final$violence_yr4_build + ela_final$mi_yr4_build + ela_final$incar_yr4_build + ela_final$su_yr4_build

#save yr4 data
yr4_scores_final = ela_final[c("src_subject_id", "aces_yr4_build", "abuse_phy_yr4_build", "abuse_sex_yr4_build", "abuse_emo_yr4_build", "neglect_phy_yr4_build", "neglect_emo_yr4_build", "divorce_yr4_build", "violence_yr4_build", "mi_yr4_build", "incar_yr4_build", "su_yr4_build")]

#prep for return to long format
yr4_scores_final$eventname="ses-04A"
lookup = c(aces_proxy = "aces_yr4_build", abuse_phy = "abuse_phy_yr4_build", abuse_sex = "abuse_sex_yr4_build", abuse_emo = "abuse_emo_yr4_build", neglect_phy = "neglect_phy_yr4_build", neglect_emo = "neglect_emo_yr4_build", divorce = "divorce_yr4_build", violence = "violence_yr4_build", mental = "mi_yr4_build", incar = "incar_yr4_build", sud = "su_yr4_build")
yr4_scores_final=rename(yr4_scores_final, all_of(lookup))

#yr5 by domain
ela_final$abuse_phy_yr5_build = ifelse(ela_final$abuse_phy_bs == 0 & ela_final$abuse_phy_yr4 == 0, 0, 1)
ela_final$abuse_sex_yr5_build = ifelse(ela_final$abuse_sex_bs == 0 & ela_final$abuse_sex_yr4 == 0, 0, 1)
ela_final$abuse_emo_yr5_build = ifelse(ela_final$abuse_emo_bs == 0 & ela_final$abuse_emo_yr3 == 0 & ela_final$abuse_emo_yr4 == 0 & ela_final$abuse_emo_yr5 == 0, 0, 1)
ela_final$neglect_phy_yr5_build = ifelse(ela_final$neglect_phy_bs == 0 & ela_final$neglect_phy_yr3 == 0 & ela_final$neglect_phy_yr4 == 0 & ela_final$neglect_phy_yr5 == 0, 0, 1)
ela_final$neglect_emo_yr5_build = ifelse(ela_final$neglect_emo_bs == 0 & ela_final$neglect_emo_yr3 == 0 & ela_final$neglect_emo_yr5 == 0, 0, 1)
ela_final$divorce_yr5_build = ifelse(ela_final$divorce_bs == 0 & ela_final$divorce_yr3 == 0 & ela_final$divorce_yr4 == 0 & ela_final$divorce_yr5 == 0, 0, 1)
ela_final$mi_yr5_build = ifelse(ela_final$mi_bs == 0 & ela_final$mi_yr3 == 0 & ela_final$mi_yr4 == 0 & ela_final$mi_yr5 == 0, 0, 1)
ela_final$incar_yr5_build = ifelse(ela_final$incar_bs == 0 & ela_final$incar_yr3 == 0 & ela_final$incar_yr4 == 0 & ela_final$incar_yr5 == 0, 0, 1)
ela_final$su_yr5_build = ifelse(ela_final$su_bs == 0 & ela_final$su_yr3 == 0 & ela_final$su_yr4 == 0 & ela_final$su_yr5 == 0, 0, 1)
ela_final$violence_yr5_build = ifelse(ela_final$violence_bs == 0 & ela_final$violence_yr4 == 0, 0, 1)

#yr5 sum score
ela_final$aces_yr5_build = ela_final$abuse_phy_yr5_build + ela_final$abuse_sex_yr5_build + ela_final$abuse_emo_yr5_build + ela_final$neglect_phy_yr5_build + ela_final$neglect_emo_yr5_build + ela_final$divorce_yr5_build + ela_final$violence_yr5_build + ela_final$mi_yr5_build + ela_final$incar_yr5_build + ela_final$su_yr5_build

#save yr5 data
yr5_scores_final = ela_final[c("src_subject_id", "aces_yr5_build", "abuse_phy_yr5_build", "abuse_sex_yr5_build", "abuse_emo_yr5_build", "neglect_phy_yr5_build", "neglect_emo_yr5_build", "divorce_yr5_build", "violence_yr5_build", "mi_yr5_build", "incar_yr5_build", "su_yr5_build")]

#prep for return to long format
yr5_scores_final$eventname="ses-05A"
lookup = c(aces_proxy = "aces_yr5_build", abuse_phy = "abuse_phy_yr5_build", abuse_sex = "abuse_sex_yr5_build", abuse_emo = "abuse_emo_yr5_build", neglect_phy = "neglect_phy_yr5_build", neglect_emo = "neglect_emo_yr5_build", divorce = "divorce_yr5_build", violence = "violence_yr5_build", mental = "mi_yr5_build", incar = "incar_yr5_build", sud = "su_yr5_build")
yr5_scores_final=rename(yr5_scores_final, all_of(lookup))

#yr6 by domain
ela_final$abuse_phy_yr6_build = ifelse(ela_final$abuse_phy_bs == 0 & ela_final$abuse_phy_yr6 == 0, 0, 1)
ela_final$abuse_sex_yr6_build = ifelse(ela_final$abuse_sex_bs == 0 & ela_final$abuse_sex_yr6 == 0, 0, 1)
ela_final$abuse_emo_yr6_build = ifelse(ela_final$abuse_emo_bs == 0 & ela_final$abuse_emo_yr5 == 0 & ela_final$abuse_emo_yr6 == 0, 0, 1)
ela_final$neglect_phy_yr6_build = ifelse(ela_final$neglect_phy_bs == 0 & ela_final$neglect_phy_yr5 == 0 & ela_final$neglect_phy_yr6 == 0, 0, 1)
ela_final$neglect_emo_yr6_build = ifelse(ela_final$neglect_emo_bs == 0 & ela_final$neglect_emo_yr5 == 0 & ela_final$neglect_emo_yr6 == 0, 0, 1)
ela_final$divorce_yr6_build = ifelse(ela_final$divorce_bs == 0 & ela_final$divorce_yr5 == 0 & ela_final$divorce_yr6 == 0, 0, 1)
ela_final$violence_yr6_build = ifelse(ela_final$violence_bs == 0 & ela_final$violence_yr6 == 0, 0, 1)
ela_final$mi_yr6_build = ifelse(ela_final$mi_bs == 0 & ela_final$mi_yr5 == 0 & ela_final$mi_yr6 == 0, 0, 1)
ela_final$incar_yr6_build = ifelse(ela_final$incar_bs == 0 & ela_final$incar_yr5 == 0 & ela_final$incar_yr6 == 0, 0, 1)
ela_final$su_yr6_build = ifelse(ela_final$su_bs == 0 & ela_final$su_yr5 == 0 & ela_final$su_yr6 == 0, 0, 1)

#yr6 sum score
ela_final$aces_yr6_build = ela_final$abuse_phy_yr6_build + ela_final$abuse_sex_yr6_build + ela_final$abuse_emo_yr6_build + ela_final$neglect_phy_yr6_build + ela_final$neglect_emo_yr6_build + ela_final$divorce_yr6_build + ela_final$violence_yr6_build + ela_final$mi_yr6_build + ela_final$incar_yr6_build + ela_final$su_yr6_build

#save yr6 data
yr6_scores_final = ela_final[c("src_subject_id", "aces_yr6_build", "abuse_phy_yr6_build", "abuse_sex_yr6_build", "abuse_emo_yr6_build", "neglect_phy_yr6_build", "neglect_emo_yr6_build", "divorce_yr6_build", "violence_yr6_build", "mi_yr6_build", "incar_yr6_build", "su_yr6_build")]

#prep for return to long format
yr6_scores_final$eventname="ses-06A"
lookup = c(aces_proxy = "aces_yr6_build", abuse_phy = "abuse_phy_yr6_build", abuse_sex = "abuse_sex_yr6_build", abuse_emo = "abuse_emo_yr6_build", neglect_phy = "neglect_phy_yr6_build", neglect_emo = "neglect_emo_yr6_build", divorce = "divorce_yr6_build", violence = "violence_yr6_build", mental = "mi_yr6_build", incar = "incar_yr6_build", sud = "su_yr6_build")
yr6_scores_final=rename(yr6_scores_final, all_of(lookup))


#combine datasets
step1=rbind(bs_scores,yr1_scores_final)
step2=rbind(step1,yr2_scores_final)
step3=rbind(step2,yr3_scores_final)
step4=rbind(step3,yr4_scores_final)
step5=rbind(step4,yr5_scores_final)

ela_in_abcd_scores=rbind(step5,yr6_scores_final)
